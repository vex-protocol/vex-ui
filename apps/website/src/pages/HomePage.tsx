...
function StackPillars(props: {
    ...
    return (
        <section className="mt-6" aria-labelledby="vex-reference-stack-heading">
            <h2
            ...
            try {
                ...
                if (!cancelled && npmResponse.ok) {
                    try {
                        ...
                        const v = npmData["dist-tags"]?.latest?.trim() ?? "n/a";
                        if (v.length > 0) {
                            setLibvexVersion(v);
                        }
                    } catch {
    ...
    return (
        <RoutePanel splotch="home">
            ...
            <p className="hero-lede mt-4 max-w-3xl text-base leading-7 text-zinc-300 sm:text-lg">
                ...
                Our software is designed to be easy to deploy and host yourself,
                but provide a high level of security and privacy.
            </p>
            <StackPillars
